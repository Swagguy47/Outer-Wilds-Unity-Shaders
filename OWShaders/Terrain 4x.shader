// Upgrade NOTE: upgraded instancing buffer 'OuterWildsTerrainVertexColor4x' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Outer Wilds/Terrain/Vertex Color 4x"
{
	Properties
	{
		...
		_ColorG("Color (G)", Vector) = (1,1,1,0)
		...
		_ColorB("Color (B)", Vector) = (1,1,1,0)
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(OuterWildsTerrainVertexColor4x)
			UNITY_DEFINE_INSTANCED_PROP(float4, _BaseAlbedo_ST)
#define _BaseAlbedo_ST_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float4, _AlbedoR_ST)
#define _AlbedoR_ST_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float4, _AlbedoG_ST)
#define _AlbedoG_ST_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float4, _AlbedoB_ST)
#define _AlbedoB_ST_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float3, _ColorB)
#define _ColorB_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float3, _ColorG)
#define _ColorG_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float3, _ColorR)
#define _ColorR_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float3, _BaseColor)
#define _BaseColor_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float3, _DebugShowVertexColorRGBA)
#define _DebugShowVertexColorRGBA_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScaleG)
#define _NormalScaleG_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScaleR)
#define _NormalScaleR_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScale)
#define _NormalScale_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightOcclusionR)
#define _HeightOcclusionR_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightSmoothness)
#define _HeightSmoothness_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _Smoothness)
#define _Smoothness_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightSmoothnessR)
#define _HeightSmoothnessR_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _SmoothnessR)
#define _SmoothnessR_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightSmoothnessG)
#define _HeightSmoothnessG_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _SmoothnessG)
#define _SmoothnessG_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightSmoothnessB)
#define _HeightSmoothnessB_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _SmoothnessB)
#define _SmoothnessB_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightOcclusion)
#define _HeightOcclusion_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightOcclusionG)
#define _HeightOcclusionG_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScaleB)
#define _NormalScaleB_arr OuterWildsTerrainVertexColor4x
			UNITY_DEFINE_INSTANCED_PROP(float, _HeightOcclusionB)
#define _HeightOcclusionB_arr OuterWildsTerrainVertexColor4x
		UNITY_INSTANCING_BUFFER_END(OuterWildsTerrainVertexColor4x)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 clampResult151 = clamp( ( ( UnpackNormal( tex2D( _NormalG, tex2DNode113.rg ) ) * _NormalScaleG_Instance ) * i.vertexColor.g ) , float3( 0,0,0 ) , float3( 1,1,1 ) );
			...
			float3 clampResult182 = clamp( ( ( UnpackNormal( tex2D( _NormalB, tex2DNode166.rg ) ) * _NormalScaleB_Instance ) * i.vertexColor.b ) , float3( 0,0,0 ) , float3( 1,1,1 ) );
			float3 BlueNormal184 = clampResult182;
			o.Normal = ( BaseNormal46 + RedNormal66 + GreenNormal132 + BlueNormal184 );
			...
			o.Albedo = ( ( BaseAlbedo43 + RedAlbedo68 + GreenAlbedo130 + BlueAlbedo180 ) * float4( (float3( 1,1,1 ) + (_DebugShowVertexColorRGBA_Instance - float3( 0,0,0 )) * (float3( 0,0,0 ) - float3( 1,1,1 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) , 0.0 ) ).rgb;
			...
			o.Smoothness = ( BaseSmooth45 + RedSmooth67 + GreenSmooth133 + BlueSmooth183 );
			...
			o.Occlusion = ( BaseAO153 + GreenAO156 + RedAO155 + BlueAO185 );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=